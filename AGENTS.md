...
|---|---|
| dice "grill me", "entrevístame", quiere hacer brainstorm o sacar lo que tiene en la cabeza | Lee y sigue `skills/grill-me/SKILL.md` |
| **primera vez**, cuando `PERFIL.md` aún tiene marcadores sin llenar | Lee y sigue `skills/grill-me/SKILL.md`, luego escribe las respuestas en `PERFIL.md` |
| pide escribir "en mi voz", "como yo lo escribiría", un post/email/hilo/newsletter a su nombre | Lee y sigue `skills/mi-voz/SKILL.md` (lee `PERFIL.md`) |
| dice "revisión semanal", "cómo voy", "qué está atorado", o quiere un check-in periódico | Lee y sigue `skills/revision-semanal/SKILL.md` |
